...
const Countdown = () => {
  ...
  const calculateRemainingTime = () => {
    const now = new Date();
    var targetDate = new Date("November 7, 2024 08:00:00");
...
const Cricular = ({ text, time, style }) => {
  return (
    <div className="flex flex-col p-2.5  sm:p-3 bg-purple-900 hover:scale-95 md:p-4 rounded-2xl text-neutral-content">
