...
const more = [
  { name: "Why Bangkok?", href: "#whybangkok" },
...
export default function Nav() {
  ...
  return (
    <header className="z-50">
      <nav
        className={`bg-transparent lg:block hidden inset-x-0 !z-20  items-center justify-between py-3 ${
        ...
        <div className="flex items-center justify-between w-full max-w-7xl px-4 mx-auto sm:px-8">
          <Link href="/">
            <img
              ...
              alt=""
              srcSet=""
              className="md:relative md:hidden rounded mt-4  md:w-[100px] w-[60px] relative md:z-30"
            />
          </Link>
      ...
      >
        ...
        <Dialog.Panel className=" inset-y-0 right-0 z-50 w-full px-6 py-6 overflow-y-auto bg-gray-950 sm:max-w-sm sm:ring-1 sm:ring-gray-900/10">
                      ...
                      <Disclosure.Panel className="mt-2 space-y-2">
                        {schedule.map((item) => (
                          <Disclosure.Button
                            ...
                            as="a"
                            href={item.href}
                            className="block py-2 pl-6 pr-3 text-sm font-semibold leading-7 text-white rounded-lg hover:bg-gray-800"
                          >
                            {item.name}
                          </Disclosure.Button>
                        ))}
