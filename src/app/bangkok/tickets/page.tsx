      ...
      <div className="py-2 mt-20 bg-purple-700">
        <Marquee>
          <div className="flex items-center space-x-6">
            ...
            <p className="text-2xl font-bold text-white uppercase">Bangkok</p>
        ...
        <div>
            <div className="border overflow-hidden border-white/20 rounded-3xl">
              ...
              <div className="flex flex-col px-4 pb-8 space-y-3">
                <a
                  href="https://buy.copperx.io/payment/payment-link/7a5307b1-c05d-452d-b704-68a20b9b9170 "
          ...
          <div>
            <div className="border overflow-hidden border-white/20 rounded-3xl">
              ...
              <div className="flex flex-col px-4 pb-8 space-y-3">
                <a
                  href="https://buy.copperx.io/payment/payment-link/1d774656-c1bf-4740-a3df-fde037d2b885"
                  title="Buy with Crypto"
                  className="bg-purple-700 text-center py-2 inline-block rounded-lg"
                >Buy Now</a>
          ...
          <div>
            <div className="border overflow-hidden border-white/20 rounded-3xl">
              ...
              <div className="flex flex-col px-4 pb-8 space-y-3">
                <a
                  href="https://buy.copperx.io/payment/payment-link/a6409375-8e63-4d8b-abe2-c9f714bc04ed
"
                  title="Buy with Crypto"
                  className="bg-purple-700 text-center py-2 inline-block rounded-lg"
                >Buy Now</a>
