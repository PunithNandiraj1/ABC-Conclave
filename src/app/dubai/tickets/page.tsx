    ...
    <div className="relative overflow-hidden bg-cover bg-img isolate">
      ...
      <div className="py-2 mt-20 bg-purple-700">
        <Marquee>
          <div className="flex items-center space-x-6">
            ...
            <p className="text-2xl font-bold text-white">ABC conclave.com</p>
      ...
      <div className="px-6 py-24 lg:px-8 lg:pb-40">
        <div className="flex flex-col items-center max-w-4xl mx-auto text-center">
          ...
          <p className="max-w-3xl font-sato mt-6 text-lg leading-8 text-white/80">
        ...
        <div>
            <div className="border overflow-hidden border-white/20 rounded-3xl">
            <img src="/standard.png" alt="map" className="w-full h-auto" />
              ...
              <div className="flex flex-col px-4 pb-8 space-y-3">
                <a
                  href="https://buy.copperx.io/payment/payment-link/7fea5f07-30f6-412f-ae8b-a12fac57ca4c "
          ...
          <div>
            <div className="border border-white/20 overflow-hidden rounded-3xl">
            <img src="/business.png" alt="map" className="w-full h-auto" />
              <div className="flex items-center justify-between p-4">
                <div className="text-4xl font-bold tracking-wide text-white">
                  $199
                </div>
              ...
              <div className="flex flex-col px-4 pb-8 space-y-3">
                <a
                  href="https://buy.copperx.io/payment/payment-link/fc4e16ff-a3ab-4407-b10b-e9f104419908 "
                  title="Buy with Crypto"
                  className="bg-purple-700 text-center py-2 inline-block rounded-lg"
                >Buy Now</a>
          ...
          <div>
            <div className="border border-white/20 overflow-hidden rounded-3xl">
            <img src="/vip.png" alt="map" className="w-full h-auto" />
              <div className="flex items-center justify-between p-4">
                <div className="text-4xl font-bold tracking-wide text-white">
                  $399
                </div>
              ...
              <div className="flex flex-col px-4 pb-8 space-y-3">
                <a
                  href="https://buy.copperx.io/payment/payment-link/aa62ba89-ae0f-4c9d-b3e7-5a95b4ea2aa7 "
                  title="Buy with Crypto"
                  className="bg-purple-700 text-center py-2 inline-block rounded-lg"
                >Buy Now</a>
                ...
                International Buffet Luncheon
                  ...
                  <li className="flex gap-x-3">
                    <CheckCircleIcon
                      ...
                      aria-hidden="true"
                    />
                 Access to Gala Networking Dinner
